...
class Person(models.Model):
    ...
    create_time = models.DateTimeField('创建时间',  max_length=255, null=True)
    ...
    update_time = models.DateTimeField('更新日期',  max_length=255, null=True)
...
class Student(models.Model):
    ...
    entry_time = models.DateTimeField('报名日期',  max_length=255, null=True)
